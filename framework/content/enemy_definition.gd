...
@export_range(0, 999999) var cultivation_reward: int = 0
...
@export_range(0.0, 10.0, 0.01) var charge_windup_seconds: float = 0.8
@export_range(0.01, 10.0, 0.01) var charge_active_seconds: float = 0.5
@export_range(0.0, 10.0, 0.01) var charge_recovery_seconds: float = 0.6
